...
- Penn State 1997-
- Brain development, perception & action, open science
- Husband, dad, grandpa, son, brother
- ham radio, music, theatre, outdoors
...
![The PSYCH 260.001 home page contains a search bar that indexes the entire course site, including lecture notes.](../include/img/psych-260-search-bar.png){#fig-psych-260-search-bar}
...
- Reliable, reproducible, general, systematic, universal laws
- Knowledge with useful applications that benefit humankind
...
- Is vaccine X safe and for whom?
- What is likely to happen if people refuse vaccine X?
...
::: {.fragment}
- Makes new *traditions* when evidence and logic demand it
- Example
  - Schizophrenia is not caused by inadequate parenting or excessive dopamine
:::
...
::: {.question}
## What scientific advances about the neurological bases of human behavior are important for *your* future?
:::
