...
<iframe width="560" height="315" src="https://www.youtube.com/embed/NZR64EF3OpA?si=B0JOD4HLpCzefI6l" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
- Exam 01 results
  - Will go over all questions on [Monday, October 5](../schedule.qmd#mon-oct-05)
- Warm-up
- Neurotransmitters
...
```{r}
#| label: fig-exam-01-histogram
#| fig-cap: "Histogram of scores for Exam 01. Passing scores are indicated in teal."

library(ggplot2)
library(dplyr)
readr::read_csv("../private/exams/exam-01/Canvas Report - Exam 23356 - Section 001.csv", show_col_types = FALSE) |>
  select(FA26_EXAM_1) |>
  mutate(passing = FA26_EXAM_1 >= .7*40) |>
  ggplot() +
  aes(x = FA26_EXAM_1, fill = passing) +
  geom_bar() +
  theme_minimal() +
...
## Dale's Principle^[https://en.wikipedia.org/wiki/Dale%27s_principle] (revised)

- Neurons that release >1 neurotransmitter common
- Release of different combinations of neurotransmitters at different synapses is rare
- Same neuron making excitatory AND inhibitory contact also rare
...
### What PSP will occur if we *open* a Cl- channel?

- Cl- flows in, so inhibitory (IPSP)
- Cl- flows in, so excitatory (EPSP)
...
- *Glycine*
    ...
    + Also inhibitory
- *Aspartate*
    + Like Glutamate, stimulates NMDA receptor
...
:::
::: {.column width=50%}
![](http://humanphysiology.academy/Neurosciences%202015/Images/2/NEU_autonomic_nervous_system%20Merck%20Manuals.gif){width="70%" fig-align="right" #fig-ne-ans}
:::
::::
...
## Altering NT inactivation

- Enhancement: Decreases net effect of NT
- Inhibition: Increases net effect of NT
...
- Glutamate
  - Excitation
  - Learning, memory, plasticity (via NMDA receptor)
- GABA
  - Inhibition
- Acetylcholine
  - CNS output
