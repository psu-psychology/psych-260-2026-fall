...
:::
::: {.column width=50%}
![https://en.wikipedia.org/wiki/Astrocyte](https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/Astrocyte5.jpg/1024px-Astrocyte5.jpg){fig-align="right" #fig-astrocytes-2}
:::
::::
...
![https://www.brainfacts.org/brain-anatomy-and-function/cells-and-circuits/2018/schwann-cells-keep-signals-strong-012918](https://www.brainfacts.org/-/media/Brainfacts2/Brain-Anatomy-and-Function/Cells-and-Circuits/Article-Images/012918-IOTW.png){#fig-schwann-cell-big with="60%"}
...
![Pyramidal cell (left) | Stellate cell (right) from Wikipedia](https://upload.wikimedia.org/wikipedia/commons/0/0c/Pyramsdal-and-Spiny-stellate-cell.JPG){#fig-pyramidal-cell}
...
- Continuity between single-cellular and multicellular organisms
  - Neurons as specialized cells with unique functions
  - Evolutionary adaptations for complex behaviors
  - Integration of cellular and systemic levels of organization
